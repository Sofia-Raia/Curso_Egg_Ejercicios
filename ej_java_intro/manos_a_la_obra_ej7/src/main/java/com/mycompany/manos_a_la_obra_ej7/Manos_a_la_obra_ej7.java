...
package com.mycompany.manos_a_la_obra_ej7;
...
public class Manos_a_la_obra_ej7 {
    
    public static void main(String[] args) {
        Scanner leer= new Scanner (System.in);
        int motor;
        System.out.println("ingrese un numero del 1 al 4 para indicar el tipo de bomba.");
        motor= leer.nextInt();
        switch (motor) {
            case 1:
